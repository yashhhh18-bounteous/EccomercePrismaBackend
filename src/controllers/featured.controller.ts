 ...
 */
export const addFeatured = async (req: AuthRequest, res: Response) => {
  try {
 ...
 */
export const removeFeatured = async (req: AuthRequest, res: Response) => {
  try {
 ...
 */
export const addFeaturedBulk = async (
  req: AuthRequest,
  res: Response
) => {
  try {
    ...
    const data = productIds.map((id: string) => ({
      productId: Number(id)
    }));
